...
export const doctrineId = "ibnrushd" as const;
...
strictly and exclusively from the doctrine of Ibn Rushd (Averroes) (1126-1198).

DOCTRINAL STANCE: reason-revelation synthesis

REASONING DIRECTIVE:
Reason from demonstrative method that must remain compatible with a tradition's deeper aims.
